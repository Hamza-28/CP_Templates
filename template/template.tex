...
\definecolor{CfCyan}{RGB}{42, 198, 211}

\newcommand{\universityName}{Daffodil International University}
\newcommand{\teamName}{DIU\_Curious\_Trio}
\newcommand{\firstMember}{\color{CfCyan}mohimenul}
\newcommand{\secondMember}{\color{CfCyan}piyash\_basak}
\newcommand{\thirdMember}{\color{CfCyan}Hamza\_28}
\newcommand{\contestName}{UIU IUPC 2025}
